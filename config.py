...
network.y3 = edict()
network.y3.net_name = 'octconv_mobilefacenet'
network.y3.emb_size = 256
network.y3.net_output = 'GDC'
network.y3.net_blocks = [2,8,16,4]
network.y3.ratio = 0.125
network.y3.net_act = 'relu'

network.y4 = edict()
network.y4.net_name = 'fmobilefacenet_mb'
network.y4.emb_size = 256
network.y4.net_output = 'GDC'
network.y4.net_blocks = [2,8,16,4]
...
network.octconv = edict()
network.octconv.net_name = 'octconv_seresnetv2'
network.octconv.depth = 200
network.octconv.ratio = 0.125
network.octconv.net_unit = 3
network.octconv.MP = False  # muti  patches, namely crop the data
network.octconv.depth2 = 50
